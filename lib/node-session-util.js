...
const cls_hooks_strategy_1 = require("./session-strategy/cls-hooks-strategy");
class NodeSessionUtil {
    constructor(props) {
        const { sessionStrategy = new cls_hooks_strategy_1.ClsHooksStrategy() } = props !== null && props !== void 0 ? props : {};
