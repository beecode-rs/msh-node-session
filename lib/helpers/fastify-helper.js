  ...
  return _createClass(FastifyHelper, [{
    ...
    value: function _plugin(fastify, opts, next) {
      var _opts$defaults,
        _opts$hook,
        _this = this;
      var defaults = (_opts$defaults = opts.defaults) !== null && _opts$defaults !== void 0 ? _opts$defaults : {};
      var hook = (_opts$hook = opts.hook) !== null && _opts$hook !== void 0 ? _opts$hook : 'onRequest';
